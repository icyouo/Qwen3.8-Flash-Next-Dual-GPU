...
CUDA_RUNTIME_SOURCES := cuda/cuda_transport.cu cuda/cuda_weights.cu cuda/q38_kernels.cu cuda/q38_gdn.cu cuda/q38_qsa.cu cuda/q38_hyper.cu cuda/q38_moe.cu cuda/q38_moe_prefill.cu cuda/q38_ple.cu cuda/cuda_backend.cu
...
$(CUDA_TEST_BIN): cuda/cuda_transport.cu cuda/q38_kernels.cu cuda/q38_gdn.cu cuda/q38_qsa.cu cuda/q38_moe.cu cuda/q38_moe_prefill.cu cuda/q38_ple.cu cuda/cuda_kernel_tests.cu src/contracts.cc $(CUDA_COMPAT_STAMP) | $(BUILD_DIR)
